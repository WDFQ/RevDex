...
/**
 * requests gemini flash with an image to identify and defines the response shape
 * @param base64Image image in base64 to send to gemini for identification
 * @param userHint image hint user provides
 * @returns the json object of the response with the shape defined within the function
 */
...
/**
 * main CaptureCardScreen function
 * @returns jsx
 */
