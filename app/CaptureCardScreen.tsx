            ...
            <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
                <View className="flex-1">
                    ...
                    <View className="flex-row items-center justify-between px-4 h-12">
                        <TouchableOpacity onPress={() => router.back()} className="w-10 h-10 -ml-2 rounded-full items-center justify-center" activeOpacity={0.6}>
                            <Ionicons name="chevron-back" size={26} color="#38bdf8" onPress={() => router.back()} />
                        </TouchableOpacity>
                            ...
                            <View className="px-5 pt-4">
                                <View className="bg-neutral-900 rounded-2xl border border-neutral-800 overflow-hidden">
                                    ...
                                    <View className="p-4 border-b border-neutral-800">
                                        <Text className="text-neutral-500 text-xs font-semibold uppercase tracking-wider mb-1">Model Designation</Text>
                                        <TextInput
                                            value={modelName}
                                    ...
                                    <View className="flex-row border-b border-neutral-800">
                                        <View className="flex-1 p-4">
                                            <Text className="text-neutral-500 text-xs font-semibold uppercase tracking-wider mb-1">Spotted Location</Text>
                                    ...
                                    <View className="flex-row border-b border-neutral-800">
                                        <View className="flex-1 p-4">
                                            <Text className="text-neutral-500 text-xs font-semibold uppercase tracking-wider mb-1">Capture Date</Text>
                                            <View className="flex-row items-center gap-1.5">
                                    ...
                                    {/* Field notes */}
                                    <View className="p-4">
                                        <Text className="text-neutral-500 text-xs font-semibold uppercase tracking-wider mb-2">Field Notes</Text>
                                        <TextInput
                                            value={fieldNotes}
                    ...
                    <View className="flex-row items-center gap-3 px-5 py-3 border-t border-neutral-800">
                        <TouchableOpacity className="w-12 h-12 rounded-full border border-sky-400/30 items-center justify-center" activeOpacity={0.7}>
                            <Ionicons name="share-outline" size={20} color="#38bdf8" />
                        </TouchableOpacity>
                        <TouchableOpacity className="flex-1 h-12 bg-sky-500 rounded-xl items-center justify-center" activeOpacity={0.8}>
